...
public class PolymorphicMap extends AbstractPolymorphicMap {
   ...
   */
  public final <T> T getExact(String key, Class<T> type) {
    Objects.requireNonNull(type);
    validateKey(key);
   ...
   */
  public final <V> V getOrDefault(String key, V defaultValue) {
    validateKey(key);
   ...
   */
  public final <V> V getExactOrDefault(String key, V defaultValue) {
    validateKey(key);
   ...
   */
  public final <V> Map<String, V> extractValuesOfType(Class<V> type) {
   ...
   * @return Map of string to given type.
   */
  public final <V> Map<String, V> extractExactValuesOfType(Class<V> type) {
    Map<String, V> exportMap = new HashMap<>();
    for (String key : map.keySet()) {
      TypedObject typedObject = map.get(key);
   ...
   * not exist.
   */
  public final Class<?> getType(String key) {
    validateKey(key);
   ...
   */
  public final <V, T> T put(String key, V value, Class<T> type) {
    Objects.requireNonNull(value);
    Objects.requireNonNull(type);
    validateKey(key);
   ...
   * @param m Input map.
   */
  public final <V> void putAll(Map<String, V> m) {
   ...
   * @param polyMap Map.
   */
  public final void putAll(PolymorphicMap polyMap) {
   ...
   * the specified type.
   */
  public final <T> T remove(String key, Class<T> type) {
    validateKey(key);
   ...
   */
  public final <T> T removeExact(String key, Class<T> type) {
    validateKey(key);
